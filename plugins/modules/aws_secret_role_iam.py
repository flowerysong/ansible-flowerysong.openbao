...
short_description: Manage AWS iam_user secret roles in OpenBao
description:
  - Manage AWS iam_user secret roles in OpenBao.
  - The underlying API is the same one used by C(aws_secret_role_sts), so either
    module can delete roles created by the other.
seealso:
  - module: flowerysong.openbao.aws_secret_role_sts
version_added: 0.2.0
