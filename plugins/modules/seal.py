...
short_description: Manage the seal status of OpenBao
description:
  - Manage the seal status of OpenBao.
version_added: 0.1.0
...
options:
  state:
    description:
      - Desired seal state.
      - If OpenBao is sealed, I(state=sealed) will reset any unsealing progress that has been made.
    type: str
    choices:
      - sealed
      - unsealed
