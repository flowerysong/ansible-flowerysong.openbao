...
def main():
    ...
    module.run(
        ...
        config=dict(type='external'),
        result_key='group',
        bad_keys=('id', 'creation_time', 'last_update_time', 'modify_index', 'namespace_id', 'name', 'alias', 'member_group_ids', 'member_entity_ids'),
    )
