...
short_description: Manage AWS authentication roles in OpenBao
description:
  - Manage AWS authentication roles in OpenBao.
...
options:
  ...
  inferred_entity_type:
    ...
    choices:
      - ec2_instance
    description:
      - Enables additional constraints by telling OpenBao to assume that the
